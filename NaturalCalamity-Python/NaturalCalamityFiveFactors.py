...
print dt_score
sql = "INSERT INTO python_test_five(Name,pydata) VALUES ('dt_score','"+str(dt_score)+"')"
"""print dt_score"""
insertSql(sql)
...
print svm_score
sql = "INSERT INTO python_test_five(Name,pydata) VALUES ('svm_score','"+str(svm_score)+"')"
"""print dt_score"""
insertSql(sql)
...
print svmlc_score
sql = "INSERT INTO python_test_five(Name,pydata) VALUES ('svmlc_score','"+str(svmlc_score)+"')"
"""print dt_score"""
insertSql(sql)
...
print nb_score
sql = "INSERT INTO python_test_five(Name,pydata) VALUES ('nb_score','"+str(nb_score)+"')"
"""print dt_score"""
insertSql(sql)
