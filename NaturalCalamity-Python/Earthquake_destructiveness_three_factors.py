...
sql = "INSERT INTO earthquakethree(Name,pydata) VALUES ('dt_score','"+str(dt_score)+"')"
"""print dt_score"""
insertSql(sql)
"""
SVM
...
sql = "INSERT INTO earthquakethree(Name,pydata) VALUES ('svm_score','"+str(svm_score)+"')"
"""print dt_score"""
insertSql(sql)
...
sql = "INSERT INTO earthquakethree(Name,pydata) VALUES ('svmlc_score','"+str(svmlc_score)+"')"
"""print dt_score"""
insertSql(sql)
...
sql = "INSERT INTO earthquakethree(Name,pydata) VALUES ('nb_score','"+str(nb_score)+"')"
"""print dt_score"""
insertSql(sql)
...
sql = "INSERT INTO earthquakethree(Name,pydata) VALUES ('KNN_score','"+str(KNN_score)+"')"
"""print dt_score"""
insertSql(sql)
