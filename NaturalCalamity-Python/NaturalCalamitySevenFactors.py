...
sql = "INSERT INTO python_test(Name,pydata) VALUES ('dt_score','"+str(dt_score)+"')"
"""print dt_score"""
insertSql(sql)

for index in range(0,len(predict_values)):
    predsql="INSERT INTO predictfactors(id,predicted_val,ytest) VALUES ('"+str(index)+"','"+str(predict_values[index])+"','"+str(y_test[index])+"')"
    insertSql(predsql)
...
sql = "INSERT INTO python_test(Name,pydata) VALUES ('svm_score','"+str(svm_score)+"')"
"""print svm_score"""
insertSql(sql)
...
sql = "INSERT INTO python_test(Name,pydata) VALUES ('svmlc_score','"+str(svmlc_score)+"')"
"""print svmlc_score"""
insertSql(sql)
...
sql = "INSERT INTO python_test(Name,pydata) VALUES ('nb_score','"+str(nb_score)+"')"
"""print nb_score"""
insertSql(sql)
...
print KNN_score
sql = "INSERT INTO python_test(Name,pydata) VALUES ('KNN_score','"+str(KNN_score)+"')"
args = "'"+str(KNN_score)+"'"
insertSql(sql)
