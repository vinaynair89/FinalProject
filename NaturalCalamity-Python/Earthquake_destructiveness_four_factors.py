...
sql = "INSERT INTO earthquakefour(Name,pydata) VALUES ('dt_score','"+str(dt_score)+"')"
"""print dt_score"""
insertSql(sql)
...
sql = "INSERT INTO earthquakefour(Name,pydata) VALUES ('nb_score','"+str(nb_score)+"')"
"""print dt_score"""
insertSql(sql)
...
sql = "INSERT INTO earthquakefour(Name,pydata) VALUES ('KNN_score','"+str(KNN_score)+"')"
"""print dt_score"""
insertSql(sql)
