...
*! Revision History
*! ===================================
*! 12/07/2015, Asif N, Frontend GUI and layout created
* =========================================================================== */
...
namespace Cmpe295_SMSapplication
{
    partial class Cmpe295_SMSapplication
    {
        /// <summary>
        ...
        private void InitializeComponent()
        {
            ...
            this.gboPortSettings.Enter += new System.EventHandler(this.gboPortSettings_Enter);
            // 
            // btnOK
            // 
            ...
            this.Name = "CMPE 295 SMS Application v2.7";
            this.Text = "CMPE 295 SMS Application v2.7";
