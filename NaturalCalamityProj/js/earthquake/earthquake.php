...
$result = mysql_query("select City, CAST(SUM(AirPressure) as decimal(53,2)) as AirPressure, CAST(SUM(MoistureDensity) as decimal(53,2)) as MoistureDensity from nc_weather group by City limit 4");
